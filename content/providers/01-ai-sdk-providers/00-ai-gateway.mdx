...
console.log(`Prompt tokens: ${generation.tokensPrompt}`);
console.log(`Completion tokens: ${generation.tokensCompletion}`);
```
...
- **tokensPrompt** _number_ - Number of prompt tokens
- **tokensCompletion** _number_ - Number of completion tokens
- **nativeTokensPrompt** _number_ - Native prompt tokens (provider-specific)
- **nativeTokensCompletion** _number_ - Native completion tokens (provider-specific)
- **nativeTokensReasoning** _number_ - Reasoning tokens used (if applicable)
- **nativeTokensCached** _number_ - Cached tokens used (if applicable)
- **nativeTokensCacheCreation** _number_ - Cache creation input tokens
